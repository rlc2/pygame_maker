...
import unittest
import logging
from pygame_maker.support.css_to_style import *
...
class TestCSSStyles(unittest.TestCase):
    ...
    def test_005valid_types(self):
        ...
        valid_type2 = CSSStyleGenerator.get_css_style("_type_with_underscores { background-color: green; }")
    ...
    def test_015valid_ids(self):
        ...
        valid_id2 = CSSStyleGenerator.get_css_style("CollideableObjectType#obj_solid1 { background-color: white; }")
    ...
    def test_020valid_attr_selectors(self):
        ...
        valid_attr2 = CSSStyleGenerator.get_css_style("a[target=\"_blank\"] { background-color: peach; }")
        ...
        valid_attr3 = CSSStyleGenerator.get_css_style("input[value~=\"your\"] { border-color: red; }")
        ...
        valid_attr4 = CSSStyleGenerator.get_css_style("input[value|=\"test\"] { border-color: black; }")
        ...
        valid_attr5 = CSSStyleGenerator.get_css_style("input[value^=\"pas\"] { border-color: green; }")
        ...
        valid_attr6 = CSSStyleGenerator.get_css_style("input[value$=\"day\"] { border-color: blue; }")
        ...
        valid_attr7 = CSSStyleGenerator.get_css_style("input[value*=\"pub\"] { border-color: teal; }")
    ...
    def test_025invalid_selectors(self):
        with self.assertRaises(ParseException):
            invalid_type1 = CSSStyleGenerator.get_css_style("foo!bar { border: none; }")
        with self.assertRaises(ParseException):
            invalid_type2 = CSSStyleGenerator.get_css_style("foo.bar.baz { border: none; }")
        with self.assertRaises(ParseException):
            invalid_type3 = CSSStyleGenerator.get_css_style("foo#bar#baz { border: none; }")
        with self.assertRaises(ParseException):
            invalid_type4 = CSSStyleGenerator.get_css_style("foo[bar=baz] { border: none; }")
        with self.assertRaises(ParseException):
            invalid_type5 = CSSStyleGenerator.get_css_style("foo[bar!=\"baz\"] { border: none; }")
        with self.assertRaises(ParseException):
            invalid_type5 = CSSStyleGenerator.get_css_style("foo:bar(\"nope\") { border: none; }")
...
""")
    ...
    def test_040valid_pseudo_classes(self):
        ...
        valid_pseudo_class1 = CSSStyleGenerator.get_css_style("td:hover { background-color: blue; }")
        ...
        valid_pseudo_class4 = CSSStyleGenerator.get_css_style(".data_cell:hover { background-color: gray; }")
