    ...
    def test_005build_single_nested_action_sequence(self):
        actions=[
            (MotionAction("set_velocity_compass"),
             None),
            (SoundAction("if_sound_is_playing",
                sound="sound1"),
             False),
            (SoundAction("stop_sound",
                sound="sound1"),
             None),
            (OtherAction("else"),
             None),
            (SoundAction("play_sound",
                sound="sound1"),
             None),
            (SoundAction("if_sound_is_playing",
                sound="sound2", invert=True),
             True),
            (OtherAction("start_of_block"),
             False),
            (SoundAction("play_sound",
                sound="sound2"),
             None),
